...
import { getVariantAvailability, MedusaError } from "@biryanihouse/framework/utils"
...
import { createWorkflow, transform, when, WorkflowResponse } from "@biryanihouse/framework/workflows-sdk"
import { validateVariantOutOfStockStep } from "./steps/validate-variant-out-of-stock"
import { useQueryGraphStep } from "@biryanihouse/medusa/core-flows"
...
```ts title="src/modules/restock/service.ts"
// other imports...
import { InjectManager, MedusaContext } from "@biryanihouse/framework/utils"
...
import { getVariantAvailability, promiseAll } from "@biryanihouse/framework/utils"
import { createStep, StepResponse } from "@biryanihouse/framework/workflows-sdk"
...
import { InferTypeOf, ProductVariantDTO } from "@biryanihouse/framework/types"
...
import { createWorkflow, transform, WorkflowResponse } from "@biryanihouse/framework/workflows-sdk"
import { useQueryGraphStep } from "@biryanihouse/medusa/core-flows"
