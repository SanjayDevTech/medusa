...
Use the following methods or properties to send requests to stock location related API routes in your Medusa application. They are provided by the `@biryanihouse/js-sdk` package.
