...
When building your customizations, it's highly recommended to re-use Medusa's existing workflows and steps where possible. The following workflows and steps allow you to manage pricing and use their features in your Medusa application. They are provided by the `@biryanihouse/medusa/core-flows` package.
