...
```bash npm2yarn
npm install @biryanihouse/js-sdk@latest @biryanihouse/types@latest
```

You install two libraries:

- `@biryanihouse/js-sdk`: the Medusa JS SDK.
- `@biryanihouse/types`: Medusa's types library, which is useful if you're using TypeScript in your development.
...
import { Button, Container } from "@biryanihouse/ui"
import { useQuery } from "@tanstack/react-query"
import { sdk } from "../lib/config"
import { DetailWidgetProps, HttpTypes } from "@biryanihouse/framework/types"
