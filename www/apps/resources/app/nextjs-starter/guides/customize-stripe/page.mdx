  ...
  modules: [
    {
      ...
      options: {
        providers: [
          {
            resolve: "@biryanihouse/medusa/payment-stripe",
            id: "stripe",
            options: {
...
<Details summaryContent="Full updated code for src/modules/checkout/components/payment/index.tsx">
  ...
  import { CheckCircleSolid, CreditCard } from "@biryanihouse/icons"
  import { Button, Container, Heading, Text, clx } from "@biryanihouse/ui"
