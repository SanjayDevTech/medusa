...
This documentation provides a reference to the `addOrderTransactionStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step creates order transactions.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { addOrderTransactionStep } from "@biryanihouse/medusa/core-flows"
