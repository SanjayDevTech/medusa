...
This documentation provides a reference to the `declineOrderChangeStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step declines an order change.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { declineOrderChangeStep } from "@biryanihouse/medusa/core-flows"
