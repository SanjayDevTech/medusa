...
This documentation provides a reference to the `updateReturnsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step updates one or more returns.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { updateReturnsStep } from "@biryanihouse/medusa/core-flows"
