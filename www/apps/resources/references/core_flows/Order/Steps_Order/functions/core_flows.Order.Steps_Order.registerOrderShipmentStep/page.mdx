...
This documentation provides a reference to the `registerOrderShipmentStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step registers a shipment for an order.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { registerOrderShipmentStep } from "@biryanihouse/medusa/core-flows"
