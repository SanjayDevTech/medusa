...
This documentation provides a reference to the `cancelOrderClaimStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step cancels a claim.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { cancelOrderClaimStep } from "@biryanihouse/medusa/core-flows"
