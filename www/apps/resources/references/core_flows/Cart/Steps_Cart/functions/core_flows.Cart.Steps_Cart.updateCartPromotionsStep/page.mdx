...
This documentation provides a reference to the `updateCartPromotionsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step updates the promotions applied on a cart.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { updateCartPromotionsStep } from "@biryanihouse/medusa/core-flows"
