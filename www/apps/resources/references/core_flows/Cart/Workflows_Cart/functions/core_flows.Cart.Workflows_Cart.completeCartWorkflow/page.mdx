...
This documentation provides a reference to the `completeCartWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { completeCartWorkflow } from "@biryanihouse/medusa/core-flows"
