...
This documentation provides a reference to the `updateCartPromotionsWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { updateCartPromotionsWorkflow } from "@biryanihouse/medusa/core-flows"
