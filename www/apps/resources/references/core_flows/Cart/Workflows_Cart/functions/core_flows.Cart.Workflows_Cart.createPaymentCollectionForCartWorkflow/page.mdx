...
This documentation provides a reference to the `createPaymentCollectionForCartWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createPaymentCollectionForCartWorkflow } from "@biryanihouse/medusa/core-flows"
