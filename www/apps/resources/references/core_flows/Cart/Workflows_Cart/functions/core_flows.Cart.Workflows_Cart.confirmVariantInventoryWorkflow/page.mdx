...
This documentation provides a reference to the `confirmVariantInventoryWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { confirmVariantInventoryWorkflow } from "@biryanihouse/medusa/core-flows"
