...
This documentation provides a reference to the `updateLineItemInCartWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { updateLineItemInCartWorkflow } from "@biryanihouse/medusa/core-flows"
