...
This documentation provides a reference to the `removeUserAccountWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/644c8b9d3022fb4bc4ec6760ee4fed93b92d1b96/packages/core/core-flows/src/user/workflows/remove-user-account.ts#L41" />
...
import { removeUserAccountWorkflow } from "@biryanihouse/medusa/core-flows"
