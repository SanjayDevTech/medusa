...
This documentation provides a reference to the `createUsersWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createUsersWorkflow } from "@biryanihouse/medusa/core-flows"
