...
# updateReturnReasonsStep - Medusa Core Workflows Reference

This documentation provides a reference to the `updateReturnReasonsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
<TypeList types={[{"name":"UpdateReturnReasonStepInput","type":"`UpdateReturnReasonStepInput`","optional":false,"defaultValue":"","description":"","expandable":false,"children":[]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="updateReturnReasonsStep"/>
