...
This documentation provides a reference to the `deleteApiKeysStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step deletes one or more API keys.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { deleteApiKeysStep } from "@biryanihouse/medusa/core-flows"
