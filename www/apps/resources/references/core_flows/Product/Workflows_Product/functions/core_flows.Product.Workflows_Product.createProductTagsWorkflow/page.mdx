...
This documentation provides a reference to the `createProductTagsWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/644c8b9d3022fb4bc4ec6760ee4fed93b92d1b96/packages/core/core-flows/src/product/workflows/create-product-tags.ts#L54" />
...
import { createProductTagsWorkflow } from "@biryanihouse/medusa/core-flows"
