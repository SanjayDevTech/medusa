...
This documentation provides a reference to the `createProductTypesStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step creates one or more product types.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { createProductTypesStep } from "@biryanihouse/medusa/core-flows"
