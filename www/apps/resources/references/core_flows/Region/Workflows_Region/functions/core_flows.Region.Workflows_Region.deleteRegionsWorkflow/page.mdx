...
This documentation provides a reference to the `deleteRegionsWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/644c8b9d3022fb4bc4ec6760ee4fed93b92d1b96/packages/core/core-flows/src/region/workflows/delete-regions.ts#L32" />
...
import { deleteRegionsWorkflow } from "@biryanihouse/medusa/core-flows"
