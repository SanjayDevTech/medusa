...
This documentation provides a reference to the `updateInventoryItemsWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { updateInventoryItemsWorkflow } from "@biryanihouse/medusa/core-flows"
