...
This documentation provides a reference to the `deleteInventoryItemWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteInventoryItemWorkflow } from "@biryanihouse/medusa/core-flows"
