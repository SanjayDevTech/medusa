...
This documentation provides a reference to the `createInventoryItemsWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createInventoryItemsWorkflow } from "@biryanihouse/medusa/core-flows"
