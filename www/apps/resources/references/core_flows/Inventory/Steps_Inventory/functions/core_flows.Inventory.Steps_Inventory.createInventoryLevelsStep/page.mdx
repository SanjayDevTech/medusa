...
This documentation provides a reference to the `createInventoryLevelsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step creates one or more inventory levels.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { createInventoryLevelsStep } from "@biryanihouse/medusa/core-flows"
