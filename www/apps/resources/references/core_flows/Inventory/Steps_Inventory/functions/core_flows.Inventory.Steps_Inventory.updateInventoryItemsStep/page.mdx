...
This documentation provides a reference to the `updateInventoryItemsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step updates one or more inventory items.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { updateInventoryItemsStep } from "@biryanihouse/medusa/core-flows"
