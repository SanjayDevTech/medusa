...
This documentation provides a reference to the `updateInventoryLevelsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step updates one or more inventory levels.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { updateInventoryLevelsStep } from "@biryanihouse/medusa/core-flows"
