...
This documentation provides a reference to the `deleteCustomerGroupsWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteCustomerGroupsWorkflow } from "@biryanihouse/medusa/core-flows"
