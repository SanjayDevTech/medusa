...
This documentation provides a reference to the `linkCustomerGroupsToCustomerWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { linkCustomerGroupsToCustomerWorkflow } from "@biryanihouse/medusa/core-flows"
