...
This documentation provides a reference to the `linkCustomersToCustomerGroupWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { linkCustomersToCustomerGroupWorkflow } from "@biryanihouse/medusa/core-flows"
