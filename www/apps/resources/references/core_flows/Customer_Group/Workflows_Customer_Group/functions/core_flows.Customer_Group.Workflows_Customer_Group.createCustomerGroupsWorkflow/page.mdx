...
This documentation provides a reference to the `createCustomerGroupsWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createCustomerGroupsWorkflow } from "@biryanihouse/medusa/core-flows"
