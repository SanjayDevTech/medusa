...
This documentation provides a reference to the `createCustomerGroupsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step creates one or more customer groups.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { createCustomerGroupsStep } from "@biryanihouse/medusa/core-flows"
