...
This documentation provides a reference to the `createLinksWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createLinksWorkflow } from "@biryanihouse/medusa/core-flows"
