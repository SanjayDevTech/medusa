...
This documentation provides a reference to the `batchLinksWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { batchLinksWorkflow } from "@biryanihouse/medusa/core-flows"
