...
This documentation provides a reference to the `createRefundReasonStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step creates one or more refund reasons.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { createRefundReasonStep } from "@biryanihouse/medusa/core-flows"
