...
This documentation provides a reference to the `deleteShippingProfileWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteShippingProfileWorkflow } from "@biryanihouse/medusa/core-flows"
