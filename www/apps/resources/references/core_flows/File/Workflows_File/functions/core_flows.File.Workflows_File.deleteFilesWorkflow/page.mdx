...
This documentation provides a reference to the `deleteFilesWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteFilesWorkflow } from "@biryanihouse/medusa/core-flows"
