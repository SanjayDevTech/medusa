---
slug: /references/medusa-workflows/steps/updateStockLocationsStep
sidebar_label: updateStockLocationsStep
tags:
  - stock location
  - step
---
...
# updateStockLocationsStep - Medusa Core Workflows Reference

This documentation provides a reference to the `updateStockLocationsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.
