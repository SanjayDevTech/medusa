...
This documentation provides a reference to the `deleteFulfillmentSetsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step deletes one or more fulfillment sets.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { deleteFulfillmentSetsStep } from "@biryanihouse/medusa/core-flows"
