...
This documentation provides a reference to the `deleteShippingOptionsStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step deletes one or more shipping options.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { deleteShippingOptionsStep } from "@biryanihouse/medusa/core-flows"
