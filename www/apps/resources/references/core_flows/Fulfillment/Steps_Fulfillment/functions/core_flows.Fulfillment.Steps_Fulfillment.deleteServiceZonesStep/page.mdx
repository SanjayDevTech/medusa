...
This documentation provides a reference to the `deleteServiceZonesStep`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step deletes one or more service zones.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { deleteServiceZonesStep } from "@biryanihouse/medusa/core-flows"
