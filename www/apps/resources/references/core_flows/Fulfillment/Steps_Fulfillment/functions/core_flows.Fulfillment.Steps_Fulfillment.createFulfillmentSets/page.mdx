...
This documentation provides a reference to the `createFulfillmentSets`. It belongs to the `@biryanihouse/medusa/core-flows` package.

This step creates one or more fulfillment sets.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@biryanihouse/framework/workflows-sdk"
import { createFulfillmentSets } from "@biryanihouse/medusa/core-flows"
