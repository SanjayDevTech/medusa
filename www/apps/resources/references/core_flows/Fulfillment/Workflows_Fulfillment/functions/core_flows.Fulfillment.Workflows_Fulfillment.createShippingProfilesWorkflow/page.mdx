...
This documentation provides a reference to the `createShippingProfilesWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createShippingProfilesWorkflow } from "@biryanihouse/medusa/core-flows"
