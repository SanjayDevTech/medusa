...
This documentation provides a reference to the `deleteServiceZonesWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteServiceZonesWorkflow } from "@biryanihouse/medusa/core-flows"
