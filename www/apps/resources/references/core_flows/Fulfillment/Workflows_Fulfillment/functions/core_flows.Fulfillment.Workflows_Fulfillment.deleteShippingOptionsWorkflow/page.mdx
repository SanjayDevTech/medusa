...
This documentation provides a reference to the `deleteShippingOptionsWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteShippingOptionsWorkflow } from "@biryanihouse/medusa/core-flows"
