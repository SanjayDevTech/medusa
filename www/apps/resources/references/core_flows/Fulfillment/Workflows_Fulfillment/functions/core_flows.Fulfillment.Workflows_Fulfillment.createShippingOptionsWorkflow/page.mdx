...
This documentation provides a reference to the `createShippingOptionsWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createShippingOptionsWorkflow } from "@biryanihouse/medusa/core-flows"
