...
This documentation provides a reference to the `generateResetPasswordTokenWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { generateResetPasswordTokenWorkflow } from "@biryanihouse/medusa/core-flows"
