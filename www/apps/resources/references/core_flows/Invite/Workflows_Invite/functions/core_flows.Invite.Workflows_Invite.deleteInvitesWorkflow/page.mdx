...
This documentation provides a reference to the `deleteInvitesWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteInvitesWorkflow } from "@biryanihouse/medusa/core-flows"
