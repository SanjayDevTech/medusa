...
This documentation provides a reference to the `refreshInviteTokensWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { refreshInviteTokensWorkflow } from "@biryanihouse/medusa/core-flows"
