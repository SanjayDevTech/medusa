...
This documentation provides a reference to the `createInvitesWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createInvitesWorkflow } from "@biryanihouse/medusa/core-flows"
