...
This documentation provides a reference to the `acceptInviteWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { acceptInviteWorkflow } from "@biryanihouse/medusa/core-flows"
