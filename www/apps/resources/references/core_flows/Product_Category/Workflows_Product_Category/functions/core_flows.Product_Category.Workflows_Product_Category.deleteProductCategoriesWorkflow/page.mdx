...
This documentation provides a reference to the `deleteProductCategoriesWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteProductCategoriesWorkflow } from "@biryanihouse/medusa/core-flows"
