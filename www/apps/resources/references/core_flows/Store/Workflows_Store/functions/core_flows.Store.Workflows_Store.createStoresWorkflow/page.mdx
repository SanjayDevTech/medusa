...
This documentation provides a reference to the `createStoresWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/644c8b9d3022fb4bc4ec6760ee4fed93b92d1b96/packages/core/core-flows/src/store/workflows/create-stores.ts#L54" />
...
import { createStoresWorkflow } from "@biryanihouse/medusa/core-flows"
