...
This documentation provides a reference to the `createCustomerAccountWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createCustomerAccountWorkflow } from "@biryanihouse/medusa/core-flows"
