...
This documentation provides a reference to the `removeCustomerAccountWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { removeCustomerAccountWorkflow } from "@biryanihouse/medusa/core-flows"
