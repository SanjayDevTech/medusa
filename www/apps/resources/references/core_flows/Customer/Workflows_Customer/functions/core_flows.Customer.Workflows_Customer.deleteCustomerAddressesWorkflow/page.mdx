...
This documentation provides a reference to the `deleteCustomerAddressesWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteCustomerAddressesWorkflow } from "@biryanihouse/medusa/core-flows"
