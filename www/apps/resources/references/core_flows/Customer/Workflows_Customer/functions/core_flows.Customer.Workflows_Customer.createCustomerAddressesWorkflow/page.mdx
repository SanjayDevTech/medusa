...
This documentation provides a reference to the `createCustomerAddressesWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { createCustomerAddressesWorkflow } from "@biryanihouse/medusa/core-flows"
