...
This documentation provides a reference to the `deleteCustomersWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
import { deleteCustomersWorkflow } from "@biryanihouse/medusa/core-flows"
