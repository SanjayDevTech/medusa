...
This documentation provides a reference to the `removePriceListPricesWorkflow`. It belongs to the `@biryanihouse/medusa/core-flows` package.
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/644c8b9d3022fb4bc4ec6760ee4fed93b92d1b96/packages/core/core-flows/src/price-list/workflows/remove-price-list-prices.ts#L38" />
...
import { removePriceListPricesWorkflow } from "@biryanihouse/medusa/core-flows"
