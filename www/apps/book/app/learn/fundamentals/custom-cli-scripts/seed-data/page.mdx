...
You create the generated products using the `createProductsWorkflow` imported previously from `@biryanihouse/medusa/core-flows`. It accepts the product data as input, and returns the created products.
