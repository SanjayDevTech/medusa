...
The icons are available as an [npm package](https://www.npmjs.com/package/@biryanihouse/icons). To install the package run:

<PackageInstall packageName="@biryanihouse/icons" />

## Usage
---

```tsx
import { Sun } from "@biryanihouse/icons"
