...
Create the file \`src/modules/my-payment/service.ts\` that holds the module's main service. It must extend the \`AbstractPaymentProvider\` class imported from \`@biryanihouse/framework/utils\`:

\`\`\`ts title="src/modules/my-payment/service.ts"
import { AbstractPaymentProvider } from "@biryanihouse/framework/utils"
