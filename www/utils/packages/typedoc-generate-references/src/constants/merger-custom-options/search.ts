...
A search service must extend the \`AbstractSearchService\` class imported from the \`@biryanihouse/framework/utils\` package. If you don’t already have the package 
installed, run the following command to install it within your project:

\`\`\`bash npm2yarn
npm install @biryanihouse/utils
\`\`\`
