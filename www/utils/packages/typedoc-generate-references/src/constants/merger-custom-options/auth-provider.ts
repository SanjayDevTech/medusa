...
Create the file \`src/modules/my-auth/service.ts\` that holds the module's main service. It must extend the \`AbstractAuthModuleProvider\` class imported from \`@biryanihouse/framework/utils\`:

\`\`\`ts title="src/modules/my-auth/service.ts"
import { AbstractAuthModuleProvider } from "@biryanihouse/framework/utils"
...
import { Modules, ContainerRegistrationKeys } from "@biryanihouse/framework/utils"
