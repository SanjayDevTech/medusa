...
```bash
npm install @biryanihouse/product
```
...
const nextConfig = {
  experimental: {
    serverComponentsExternalPackages: ["@biryanihouse/product"],
  },
}
...
import { initialize as initializeProductModule } from "@biryanihouse/product"
