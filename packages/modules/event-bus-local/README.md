...
The Node EventEmitter is limited to a single process environment. We generally recommend using the `@biryanihouse/event-bus-redis` module in a production environment.
...
```bash
yarn add @biryanihouse/event-bus-local
```
