import { Input, Textarea } from "@biryanihouse/ui"
            ...
            render={({ field }) => {
              return (
                <Form.Item>
                  ...
                  <Form.Control>
                    <Input {...field} placeholder="Chicken Biryani" />
                  </Form.Control>
                </Form.Item>
              )
            }}
            ...
            render={({ field }) => {
              return (
                <Form.Item>
                  ...
                  <Form.Control>
                    <Input {...field} placeholder="Traditional biryani with chicken dish" />
                  </Form.Control>
                </Form.Item>
              )
            }}
            ...
            render={({ field }) => {
              return (
                <Form.Item>
                  ...
                  <Form.Control>
                    <HandleInput {...field} placeholder="chicken-biryani" />
                  </Form.Control>
                </Form.Item>
              )
            }}
        ...
        render={({ field }) => {
          return (
            <Form.Item>
              ...
              <Form.Control>
                <Textarea {...field} placeholder="Traditional biryani with chicken dish" />
              </Form.Control>
            </Form.Item>
          )
        }}
